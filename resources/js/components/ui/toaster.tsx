import { IconAlertCircle, IconAlertTriangle, IconCircleCheck, IconLoader } from 'cleon-icons'
    ...
    return (
        <ToasterPrimitive
            ...
            toastOptions={{
                ...
                classNames: {
                    toast: cn(
                        'bg-background ring-1 ring-muted dark:ring-inset sm:min-w-[22rem] rounded-xl text-foreground overflow-hidden text-[0.925rem] backdrop-blur-xl px-4 py-3 font-normal sm:px-5 sm:py-5',
