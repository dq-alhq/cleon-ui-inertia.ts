...
const noteStyles = tv({
    ...
    variants: {
        variant: {
            ...
            info: ['border-info/20 [&_a]:text-info text-info bg-info/10 [&_[data-slot=icon]]:text-info leading-4'],
            warning: [
    ...
    return (
        <div className={noteStyles({ variant, className })} {...props}>
            <div className='flex items-start gap-x-3'>
                ...
                <Text slot='description' {...props} className={cn('text-sm block', className)}>
                    {props.children}
                </Text>
            </div>
        </div>
