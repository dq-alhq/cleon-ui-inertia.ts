...
const linkStyles = tv({
    ...
    variants: {
        variant: {
            ...
            primary: 'text-primary hover:brightness-90 forced-colors:disabled:text-[GrayText]',
            danger: 'text-danger hover:brightness-90 forced-colors:disabled:text-[GrayText]',
            secondary: 'text-secondary hover:brightness-90 forced-colors:disabled:text-[GrayText]'
        }
    },
    defaultVariants: {
        variant: 'unstyled'
