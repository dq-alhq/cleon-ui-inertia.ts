...
export default function Register() {
    ...
    return (
        <>
            ...
            <Form onSubmit={submit} validationErrors={errors} className='space-y-4'>
                <TextField
                    type='text'
                    name='name'
                    label='Name'
                ...
                {import.meta.env.VITE_HAS_TERMS_AND_PRIVACY_POLICY_FEATURE && (
                    <div className='flex items-center gap-x-1'>
                        ...
                        <Link target='_blank' href={route('terms.show')} variant='primary'>
                            terms of service
                        </Link>{' '}
                        and{' '}
                        <Link target='_blank' href={route('privacy.show')} variant='primary'>
                            privacy policy
                        </Link>
                    </div>
                )}
